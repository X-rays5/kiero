...
namespace kiero {
  ...
  [[maybe_unused]] Status::Enum bind(uint16_t index, void** original, void* function);
  [[maybe_unused]] void unbind(uint16_t index);

  [[maybe_unused]] RenderType::Enum getRenderType();
  [[maybe_unused]] uint150_t* getMethodsTable();
}
